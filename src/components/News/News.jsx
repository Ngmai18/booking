          ...
          <TabPanel value={value} index={0}>
            <div className="row">
              <div className={classes.repons}>
                <a
                  href="https://gamek.vn/an-dinh-chac-nich-ngay-khoi-chieu-16-04-ly-hai-tung-clip-lat-mat-48h-dam-chat-fast-furious-mien-song-nuoc-20210330120030941.chn"
              ...
              <div className={classes.repons}>
                <a
                  href="https://dep.com.vn/dan-dien-vien-thuc-luc-tu-dong-sang-tay-cua-mortal-kombat-cuoc-chien-sinh-tu/"
                  className={classes.news}
                >
                  <img
                    className={classes.fullImg}
            ...
            <div className="row">
              <div className="col-sm-4 pl-0 pr-15">
                <a
                  href="https://thanhnien.vn/bong-hong-nuoc-anh-carey-mulligan-va-man-tra-thu-dan-ong-cuc-gat-post1049160.html"
                  className={classes.news}
                >
                  <img
                    className={classes.fullImg}
              ...
              <div className="col-sm-4 pl-0 pr-15">
                <a
                  href="https://dep.com.vn/vua-dep-lai-vua-tai-nang-dan-sao-nam-cua-phim-ban-tay-diet-quy-san-sang-don-tim-hoi-chi-em/#:~:text=Ngo%C3%A0i%20n%E1%BB%99i%20dung%20th%C3%BA%20v%E1%BB%8B,Hwan%20v%C3%A0%20Choi%20Woo%20Sik."
                  className={classes.news}
                >
                  <img
                    className={classes.fullImg}
              ...
              <div className="col-sm-4 pl-0 pr-15">
                <a
                  ...
                  href="https://www.facebook.com/media/set/?set=a.1864131733755723&type=3"
                >
                ...
                <a
                  className={classes.bonusNews}
                  href="https://yeahtravel.co/331-boc-tem-goc-check-in-moi-toanh-o-ha-noi-len-hinh-cu-phai-goi-la-chat-lu-lu-d1370.html"
                >
                  <div className="row mb-2">
                    <div className="col-3 px-0">
                      <img
                ...
                <a
                  className={classes.bonusNews}
                  href="https://vov.vn/van-hoa/san-khau-dien-anh/tiec-trang-mau-can-moc-100-ty-sau-2-tuan-cong-chieu-814804.vov"
                >
                  <div className="row mb-2">
                    <div className="col-3 px-0">
                      <img
                ...
                <a
                  className={classes.bonusNews}
                  href="NGÔ THANH VÂN CHÍNH THỨC KHỞI ĐỘNG CUỘC THI THIẾT"
                >
                  <div className="row mb-2">
                    <div className="col-3 px-0">
                      <img
